/*
* @Author: zhengy
* @Date:   2017-06-05 10:30:26
* @Last Modified by:   zhengy
* @Last Modified time: 2017-06-05 10:31:18
*/
  ...
  var vrGameDetail = {
      ...
      init:function(config){
        ...
        $(document).on('click','.game_detail',function(e){
          p.checkDetail('game',$(this).attr('data-val'));
        })
      },
      //检查详情页
      ...
      updateLike:function(like){
          ...
          $(like.data).each(function(k,v){
            if(k<16){
              html+='<li class="pr page'+Math.floor(k/4+1)+'" data-page="'+Math.floor(k/4+1)+'" style="background-image:url(\''+p.parameter.url+'/'+v.image.logo+'\');">'+
                  ...
                  '<div class="right_detail_con fr">'+
                      '<div class="download_con tac">'+
                          ...
                          '<div class="download_btn">'+
                              ...
                              '<div class="buy_game pr cp ">'+
                                  ...
                                  '<div class="fr tal">'+
                                      '<p class="f20 ">立即购买</p>'+
                                      '<p class="size ">￥58.00</p>'+
                                  '</div>'+
                              '</div>'+
                              '<div class="down_progress_con show">'+
                      ...
                      '<div class="friend_play_game">'+
                          ...
                          '<div class="recommend_game">'+
                              '<h4 class="f16">猜你喜欢<span class="fr f12"><i class="resh_con  icon"></i>换一批</span></h4>'+
                              '<ul>'+
                                  '<li class="pr" >'+
                                      '<div class="msg_con pa">'+
