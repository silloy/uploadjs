...
class BankHelper
{
     ...
     *
     */
    public static function getBankType($cardno)
    {
        if (!$cardno) {
            return false;
        }
        $bankList = [
            '621098'     => '邮政储蓄银行-绿卡通-借记卡',
            '622150'     => '邮政储蓄银行-绿卡银联标准卡-借记卡',
            '622151'     => '邮政储蓄银行-绿卡银联标准卡-借记卡',
            '622181'     => '邮政储蓄银行-绿卡专用卡-借记卡',
            '622188'     => '邮政储蓄银行-绿卡银联标准卡-借记卡',
            '955100'     => '邮政储蓄银行-绿卡(银联卡)-借记卡',
            '621095'     => '邮政储蓄银行-绿卡VIP卡-借记卡',
            '620062'     => '邮政储蓄银行-银联标准卡-借记卡',
            '621285'     => '邮政储蓄银行-中职学生资助卡-借记卡',
            '621798'     => '邮政储蓄银行-IC绿卡通VIP卡-借记卡',
            '621799'     => '邮政储蓄银行-IC绿卡通-借记卡',
            '621797'     => '邮政储蓄银行-IC联名卡-借记卡',
            '620529'     => '邮政储蓄银行-IC预付费卡-预付费卡',
            '622199'     => '邮政储蓄银行-绿卡银联标准卡-借记卡',
            '621096'     => '邮政储蓄银行-绿卡通-借记卡',
            '62215049'   => '邮政储蓄银行.河南分行-绿卡储蓄卡(银联卡)-借记卡',
            '62215050'   => '邮政储蓄银行.河南分行-绿卡储蓄卡(银联卡)-借记卡',
            '62215051'   => '邮政储蓄银行.河南分行-绿卡储蓄卡(银联卡)-借记卡',
            '62218850'   => '邮政储蓄银行.河南分行-绿卡储蓄卡(银联卡)-借记卡',
            '62218851'   => '邮政储蓄银行.河南分行-绿卡储蓄卡(银联卡)-借记卡',
            '62218849'   => '邮政储蓄银行.河南分行-绿卡储蓄卡(银联卡)-借记卡',
            ...
            '622812'     => '邮政储蓄银行.信用卡中心(61000000)-银联标准白金卡-贷记卡',
            '622810'     => '邮政储蓄银行.信用卡中心(61000000)-银联标准贷记卡-贷记卡',
            '622811'     => '邮政储蓄银行.信用卡中心(61000000)-银联标准贷记卡-贷记卡',
            '628310'     => '邮政储蓄银行.信用卡中心(61000000)-银联标准公务卡-贷记卡',
            '625919'     => '邮政储蓄银行.信用卡中心(61000000)-上海购物信用卡-贷记卡',
            ...
            '544210'     => '工商银行-牡丹东航联名卡-贷记卡',
            '548943'     => '工商银行-牡丹东航联名卡-贷记卡',
            '370267'     => '工商银行-牡丹运通白金卡-贷记卡',
            '621558'     => '工商银行-福农灵通卡-借记卡',
            '621559'     => '工商银行-福农灵通卡-借记卡',
            '621722'     => '工商银行-灵通卡-借记卡',
            '621723'     => '工商银行-灵通卡-借记卡',
            '620086'     => '工商银行-中国旅行卡-借记卡',
            '621226'     => '工商银行-牡丹卡普卡-借记卡',
            '402791'     => '工商银行-国际借记卡-借记卡',
            '427028'     => '工商银行-国际借记卡-借记卡',
            '427038'     => '工商银行-国际借记卡-借记卡',
            '548259'     => '工商银行-国际借记卡-借记卡',
            '356879'     => '工商银行-牡丹JCB信用卡-贷记卡',
            '356880'     => '工商银行-牡丹JCB信用卡-贷记卡',
            '356881'     => '工商银行-牡丹JCB信用卡-贷记卡',
            '356882'     => '工商银行-牡丹JCB信用卡-贷记卡',
            '528856'     => '工商银行-牡丹多币种卡-贷记卡',
            '621618'     => '工商银行-武警军人保障卡-借记卡',
            '620516'     => '工商银行-预付芯片卡-借记卡',
            '621227'     => '工商银行-理财金账户金卡-借记卡',
            '621721'     => '工商银行-灵通卡-借记卡',
            '900010'     => '工商银行-牡丹宁波市民卡-借记卡',
            '625330'     => '工商银行-中国旅游卡-贷记卡',
            '625331'     => '工商银行-中国旅游卡-贷记卡',
            '625332'     => '工商银行-中国旅游卡-贷记卡',
            '623062'     => '工商银行-借记卡-借记卡',
            '622236'     => '工商银行-借贷合一卡-贷记卡',
            '621670'     => '工商银行-普通高中学生资助卡-借记卡',
            '524374'     => '工商银行-牡丹多币种卡-贷记卡',
            '550213'     => '工商银行-牡丹多币种卡-贷记卡',
            '374738'     => '工商银行-牡丹百夫长信用卡-贷记卡',
            '374739'     => '工商银行-牡丹百夫长信用卡-贷记卡',
            '621288'     => '工商银行-工银财富卡-借记卡',
            '625708'     => '工商银行-中小商户采购卡-贷记卡',
            '625709'     => '工商银行-中小商户采购卡-贷记卡',
            '622597'     => '工商银行-环球旅行金卡-贷记卡',
            '622599'     => '工商银行-环球旅行白金卡-贷记卡',
            '360883'     => '工商银行-牡丹工银大来卡-贷记卡',
            '360884'     => '工商银行-牡丹工银大莱卡-贷记卡',
            '625865'     => '工商银行-IC金卡-贷记卡',
            '625866'     => '工商银行-IC白金卡-贷记卡',
            '625899'     => '工商银行-工行IC卡（红卡）-贷记卡',
            '625929'     => '工商银行.布鲁塞尔-贷记卡-贷记卡',
            '621376'     => '工商银行.布鲁塞尔分行-借记卡-借记卡',
            '620054'     => '工商银行.布鲁塞尔分行-预付卡-预付费卡',
            '620142'     => '工商银行.布鲁塞尔分行-预付卡-预付费卡',
            '621423'     => '工商银行.（巴西）-借记卡-借记卡',
            '625927'     => '工商银行.（巴西）-贷记卡-贷记卡',
            '621428'     => '工商银行.金边分行-借记卡-借记卡',
            '625939'     => '工商银行.金边分行-信用卡-贷记卡',
            '621434'     => '工商银行.金边分行-借记卡-借记卡',
            '625987'     => '工商银行.金边分行-信用卡-贷记卡',
            '621761'     => '工商银行.加拿大分行-借记卡-借记卡',
            '621749'     => '工商银行.加拿大分行-借记卡-借记卡',
            '620184'     => '工商银行.加拿大分行-预付卡-预付费卡',
            '625930'     => '工商银行.加拿大-贷记卡-贷记卡',
            '621300'     => '工商银行.巴黎分行-借记卡-借记卡',
            '621378'     => '工商银行.巴黎分行-借记卡-借记卡',
            '625114'     => '工商银行.巴黎分行-贷记卡-贷记卡',
            '622159'     => '工商银行.法兰克福分行-贷记卡-贷记卡',
            '621720'     => '工商银行.法兰克福分行-借记卡-借记卡',
            '625021'     => '工商银行.法兰克福分行-贷记卡-贷记卡',
            '625022'     => '工商银行.法兰克福分行-贷记卡-贷记卡',
            '625932'     => '工商银行.法兰克福-贷记卡-贷记卡',
            '621379'     => '工商银行.法兰克福分行-借记卡-借记卡',
            '620114'     => '工商银行.法兰克福分行-预付卡-预付费卡',
            '620146'     => '工商银行.法兰克福分行-预付卡-预付费卡',
            '622889'     => '工商银行.(亚洲)有限公司-ICBC(Asia) Credit-贷记卡',
            '625900'     => '工商银行.(亚洲)有限公司-ICBC Credit Card-贷记卡',
            '622949'     => '工商银行.(亚洲)有限公司-EliteClubATMCard-借记卡',
            '625915'     => '工商银行.(亚洲)有限公司-港币信用卡-贷记卡',
            '625916'     => '工商银行.(亚洲)有限公司-港币信用卡-贷记卡',
            '620030'     => '工商银行.(亚洲)有限公司-工银亚洲预付卡-预付费卡',
            '620050'     => '工商银行.(亚洲)有限公司-预付卡-预付费卡',
            '622944'     => '工商银行.(亚洲)有限公司-CNYEasylinkCard-借记卡',
            '625115'     => '工商银行.(亚洲)有限公司-工银银联公司卡-贷记卡',
            '620101'     => '工商银行.(亚洲)有限公司--预付费卡',
            '623335'     => '工商银行.(亚洲)有限公司--预付费卡',
            '622171'     => '工商银行.(印尼)-印尼盾复合卡-贷记卡',
            '621240'     => '工商银行.(印尼)-借记卡-借记卡',
            '621724'     => '工商银行.印尼分行-借记卡-借记卡',
            '625931'     => '工商银行.印尼-贷记卡-贷记卡',
            '621762'     => '工商银行.（印度尼西亚）-借记卡-借记卡',
            '625918'     => '工商银行.印尼分行-信用卡-贷记卡',
            '625113'     => '工商银行.米兰-贷记卡-贷记卡',
            '621371'     => '工商银行.米兰分行-借记卡-借记卡',
            '620143'     => '工商银行.米兰分行-预付卡-预付费卡',
            '620149'     => '工商银行.米兰分行-预付卡-预付费卡',
            '621730'     => '工商银行.东京分行-工行东京借记卡-借记卡',
            '625928'     => '工商银行.阿拉木图-贷记卡-贷记卡',
            '621414'     => '工商银行.阿拉木图子行-借记卡-借记卡',
            '625914'     => '工商银行.阿拉木图子行-贷记卡-贷记卡',
            '621375'     => '工商银行.阿拉木图子行-借记卡-借记卡',
            '620187'     => '工商银行.阿拉木图子行-预付卡-预付费卡',
            '621734'     => '工商银行.首尔-借记卡-借记卡',
            '621433'     => '工商银行.万象分行-借记卡-借记卡',
            '625986'     => '工商银行.万象分行-贷记卡-贷记卡',
            '621370'     => '工商银行.卢森堡分行-借记卡-借记卡',
            '625925'     => '工商银行.卢森堡分行-贷记卡-贷记卡',
            '622926'     => '工商银行.澳门分行-E时代卡-借记卡',
            '622927'     => '工商银行.澳门分行-E时代卡-借记卡',
            '622928'     => '工商银行.澳门分行-E时代卡-借记卡',
            '622929'     => '工商银行.澳门分行-理财金账户-借记卡',
            '622930'     => '工商银行.澳门分行-理财金账户-借记卡',
            '622931'     => '工商银行.澳门分行-理财金账户-借记卡',
            '621733'     => '工商银行.（澳门）-借记卡-借记卡',
            '621732'     => '工商银行.（澳门）-借记卡-借记卡',
            '620124'     => '工商银行.澳门分行-预付卡-预付费卡',
            '620183'     => '工商银行.澳门分行-预付卡-预付费卡',
            '620561'     => '工商银行.澳门分行-工银闪付预付卡-预付费卡',
            '625116'     => '工商银行.澳门分行-工银银联公司卡-贷记卡',
            '622227'     => '工商银行.澳门分行-Diamond-贷记卡',
            '625921'     => '工商银行.马来西亚-贷记卡-贷记卡',
            '621764'     => '工商银行.马来西亚-借记卡-借记卡',
            '625926'     => '工商银行.阿姆斯特丹-贷记卡-贷记卡',
            '621372'     => '工商银行.阿姆斯特丹-借记卡-借记卡',
            '623034'     => '工商银行.新西兰-借记卡-借记卡',
            '625110'     => '工商银行.新西兰-信用卡-贷记卡',
            '621464'     => '工商银行.卡拉奇分行-借记卡-借记卡',
            '625942'     => '工商银行.卡拉奇分行-贷记卡-贷记卡',
            '622158'     => '工商银行.新加坡分行-贷记卡-贷记卡',
            '625917'     => '工商银行.新加坡分行-贷记卡-贷记卡',
            '621765'     => '工商银行.新加坡分行-借记卡-借记卡',
            '620094'     => '工商银行.新加坡分行-预付卡-预付费卡',
            '620186'     => '工商银行.新加坡分行-预付卡-预付费卡',
            '621719'     => '工商银行.新加坡分行-借记卡-借记卡',
            '625922'     => '工商银行.河内-贷记卡-贷记卡',
            '621369'     => '工商银行.河内-借记卡-借记卡',
            '621763'     => '工商银行.河内-工银越南盾借记卡-借记卡',
            '625934'     => '工商银行.河内-工银越南盾信用卡-贷记卡',
            '620046'     => '工商银行.河内-预付卡-预付费卡',
            '621750'     => '工商银行.马德里分行-借记卡-借记卡',
            '625933'     => '工商银行.马德里-贷记卡-贷记卡',
            '621377'     => '工商银行.马德里分行-借记卡-借记卡',
            '620148'     => '工商银行.马德里分行-预付卡-预付费卡',
            '620185'     => '工商银行.马德里分行-预付卡-预付费卡',
            '625920'     => '工商银行.泰国-贷记卡-贷记卡',
            '621367'     => '工商银行.泰国-借记卡-借记卡',
            '625924'     => '工商银行.伦敦-贷记卡-贷记卡',
            '621374'     => '工商银行.伦敦子行-借记卡-借记卡',
            '621731'     => '工商银行.伦敦子行-工银伦敦借记卡-借记卡',
            '621781'     => '工商银行.伦敦子行-借记卡-借记卡',
            '625017'     => '工商银行.（澳门）(26470446)-普卡-贷记卡',
            '625018'     => '工商银行.（澳门）(26470446)-金卡-贷记卡',
            '625019'     => '工商银行.（澳门）(26470446)-白金卡-贷记卡',
            ...
            '625826'     => '农业银行.贷记卡-IC普卡-贷记卡',
            '625827'     => '农业银行.贷记卡-IC金卡-贷记卡',
            '548478'     => '农业银行.贷记卡-澳元卡-贷记卡',
            '544243'     => '农业银行.贷记卡-欧元卡-贷记卡',
            '622820'     => '农业银行.贷记卡-金穗通商卡-准贷记卡',
            '622830'     => '农业银行.贷记卡-金穗通商卡-准贷记卡',
            '622838'     => '农业银行.贷记卡-银联白金卡-贷记卡',
            '625336'     => '农业银行.贷记卡-中国旅游卡-贷记卡',
            '628269'     => '农业银行.贷记卡-银联IC公务卡-贷记卡',
            ...
            '621648'     => '中国银行.金边分行-借记卡-借记卡',
            '621248'     => '中国银行.雅加达分行-借记卡-借记卡',
            '621215'     => '中国银行.东京分行-借记卡普卡-借记卡',
            '621249'     => '中国银行.首尔分行-借记卡-借记卡',
            '622750'     => '中国银行.澳门分行-人民币信用卡-贷记卡',
            '622751'     => '中国银行.澳门分行-人民币信用卡-贷记卡',
            '622771'     => '中国银行.澳门分行-中银卡-借记卡',
            '622772'     => '中国银行.澳门分行-中银卡-借记卡',
            '622770'     => '中国银行.澳门分行-中银卡-借记卡',
            '625145'     => '中国银行.澳门分行-中银银联双币商务卡-贷记卡',
            '620531'     => '中国银行.澳门分行-预付卡-预付费卡',
            '620210'     => '中国银行.澳门分行-澳门中国银行银联预付卡-预付费卡',
            '620211'     => '中国银行.澳门分行-澳门中国银行银联预付卡-预付费卡',
            '622479'     => '中国银行.澳门分行-熊猫卡-贷记卡',
            '622480'     => '中国银行.澳门分行-财富卡-贷记卡',
            '622273'     => '中国银行.澳门分行-银联港币卡-借记卡',
            '622274'     => '中国银行.澳门分行-银联澳门币卡-借记卡',
            '620019'     => '中国银行.(马来西亚)-预付卡-预付费卡',
            '620035'     => '中国银行.(马来西亚)-预付卡-预付费卡',
            '621231'     => '中国银行.马尼拉分行-双币种借记卡-借记卡',
            '622789'     => '中国银行.新加坡分行-BOCCUPPLATINUMCARD-贷记卡',
            '621638'     => '中国银行.胡志明分行-借记卡-借记卡',
            '621334'     => '中国银行.曼谷分行-借记卡-借记卡',
            '625140'     => '中国银行.曼谷分行-长城信用卡环球通-贷记卡',
            '621395'     => '中国银行.曼谷分行-借记卡-借记卡',
            '620513'     => '中国银行.宁波分行-长城宁波市民卡-预付费卡',
            '625055'     => '中国银行.信用卡(国际)有限公司(25180344)-商务金卡-贷记卡',
            '625040'     => '中国银行.信用卡(国际)有限公司(25180344)-中银银联双币信用卡-贷记卡',
            '625042'     => '中国银行.信用卡(国际)有限公司(25180344)-中银银联双币信用卡-贷记卡',
            '625141'     => '中国银行.信用卡(国际)有限公司(25180446)-澳门币贷记卡-贷记卡',
            '625143'     => '中国银行.信用卡(国际)有限公司(25180446)-澳门币贷记卡-贷记卡',
            ...
            '622346'     => '中国银行.香港有限公司(47980344)-人民币信用卡金卡-贷记卡',
            '622347'     => '中国银行.香港有限公司(47980344)-信用卡普通卡-贷记卡',
            '622348'     => '中国银行.香港有限公司(47980344)-中银卡(人民币)-借记卡',
            ...
            '621673'     => '建设银行-普通高中学生资助卡-借记卡',
            '623211'     => '建设银行-中国旅游卡-借记卡',
            '356896'     => '建设银行-龙卡JCB金卡-贷记卡',
            '356899'     => '建设银行-龙卡JCB白金卡-贷记卡',
            '356895'     => '建设银行-龙卡JCB普卡-贷记卡',
            '436718'     => '建设银行-龙卡贷记卡公司卡-贷记卡',
            '436738'     => '建设银行-龙卡贷记卡-贷记卡',
            '436745'     => '建设银行-龙卡国际普通卡VISA-贷记卡',
            '436748'     => '建设银行-龙卡国际金卡VISA-贷记卡',
            '489592'     => '建设银行-VISA白金信用卡-贷记卡',
            '531693'     => '建设银行-龙卡国际白金卡-贷记卡',
            '532450'     => '建设银行-龙卡国际普通卡MASTER-贷记卡',
            '532458'     => '建设银行-龙卡国际金卡MASTER-贷记卡',
            '544887'     => '建设银行-龙卡万事达金卡-贷记卡',
            '552801'     => '建设银行-龙卡贷记卡-贷记卡',
            '557080'     => '建设银行-龙卡万事达白金卡-贷记卡',
            '558895'     => '建设银行-龙卡贷记卡-贷记卡',
            '559051'     => '建设银行-龙卡万事达信用卡-贷记卡',
            '622166'     => '建设银行-龙卡人民币信用卡-贷记卡',
            '622168'     => '建设银行-龙卡人民币信用金卡-贷记卡',
            '622708'     => '建设银行-龙卡人民币白金卡-贷记卡',
            '625964'     => '建设银行-龙卡IC信用卡普卡-贷记卡',
            '625965'     => '建设银行-龙卡IC信用卡金卡-贷记卡',
            '625966'     => '建设银行-龙卡IC信用卡白金卡-贷记卡',
            '628266'     => '建设银行-龙卡银联公务卡普卡-贷记卡',
            '628366'     => '建设银行-龙卡银联公务卡金卡-贷记卡',
            '625362'     => '建设银行-中国旅游卡-贷记卡',
            '625363'     => '建设银行-中国旅游卡-贷记卡',
            '628316'     => '建设银行-龙卡IC公务卡-贷记卡',
            '628317'     => '建设银行-龙卡IC公务卡-贷记卡',
            '622381'     => '建设银行.亚洲股份有限公司(25070344)-人民币信用卡-贷记卡',
            '622675'     => '建设银行.亚洲股份有限公司(25070344)-银联卡-贷记卡',
            '622676'     => '建设银行.亚洲股份有限公司(25070344)-银联卡-贷记卡',
            '622677'     => '建设银行.亚洲股份有限公司(25070344)-银联卡-贷记卡',
            '622382'     => '建设银行.亚洲股份有限公司(25070344)-人民币卡(银联卡)-借记卡',
            '621487'     => '建设银行.亚洲股份有限公司(25070344)-借记卡-借记卡',
            '621083'     => '建设银行.亚洲股份有限公司(25070344)-建行陆港通龙卡-借记卡',
            '621084'     => '建设银行.澳门股份有限公司(25270446)-扣款卡-借记卡',
            '620107'     => '建设银行.（亚洲）(25330344)-预付卡-借记卡',
            '623251'     => '建设银行-单位结算卡-借记卡',
            '5453242'    => '建设银行-龙卡信用卡-贷记卡',
            '5491031'    => '建设银行-龙卡信用卡-贷记卡',
            '5544033'    => '建设银行-龙卡信用卡-贷记卡',
            '436742193'  => '建设银行.厦门分行-龙卡储蓄卡-借记卡',
            '622280193'  => '建设银行.厦门分行-银联储蓄卡-借记卡',
            ...
            '621069'     => '交通银行.香港分行-交通银行港币借记卡-借记卡',
            '620013'     => '交通银行.香港分行-港币礼物卡-借记卡',
            '625028'     => '交通银行.香港分行-双币种信用卡-贷记卡',
            '625029'     => '交通银行.香港分行-双币种信用卡-贷记卡',
            '621436'     => '交通银行.香港分行-双币卡-借记卡',
            '621002'     => '交通银行.香港分行-银联人民币卡-借记卡',
            '621335'     => '交通银行.澳门分行-银联借记卡-借记卡',
            ...
            '376968'     => '中信银行.信用卡中心(63020000)-中信贷记卡银联卡-贷记卡',
            '376969'     => '中信银行.信用卡中心(63020000)-中信贷记卡银联卡-贷记卡',
            '400360'     => '中信银行.信用卡中心(63020000)-中信贷记卡-贷记卡',
            '403391'     => '中信银行.信用卡中心(63020000)-中信贷记卡-贷记卡',
            '403392'     => '中信银行.信用卡中心(63020000)-中信贷记卡-贷记卡',
            '376966'     => '中信银行.信用卡中心(63020000)-中信贷记卡银联卡-贷记卡',
            '404158'     => '中信银行.信用卡中心(63020000)-中信贷记卡-贷记卡',
            '404159'     => '中信银行.信用卡中心(63020000)-中信贷记卡-贷记卡',
            '404171'     => '中信银行.信用卡中心(63020000)-中信贷记卡-贷记卡',
            '404172'     => '中信银行.信用卡中心(63020000)-中信贷记卡-贷记卡',
            '404173'     => '中信银行.信用卡中心(63020000)-中信贷记卡-贷记卡',
            '404174'     => '中信银行.信用卡中心(63020000)-中信贷记卡-贷记卡',
            '404157'     => '中信银行.信用卡中心(63020000)-中信贷记卡-贷记卡',
            '433667'     => '中信银行.信用卡中心(63020000)-中信贷记卡-贷记卡',
            '433668'     => '中信银行.信用卡中心(63020000)-中信贷记卡-贷记卡',
            '433669'     => '中信银行.信用卡中心(63020000)-中信贷记卡-贷记卡',
            '514906'     => '中信银行.信用卡中心(63020000)-中信贷记卡-贷记卡',
            '403393'     => '中信银行.信用卡中心(63020000)-中信贷记卡-贷记卡',
            '520108'     => '中信银行.信用卡中心(63020000)-中信贷记卡-贷记卡',
            '433666'     => '中信银行.信用卡中心(63020000)-中信贷记卡-贷记卡',
            '558916'     => '中信银行.信用卡中心(63020000)-中信贷记卡-贷记卡',
            '622678'     => '中信银行.信用卡中心(63020000)-中信银联标准贷记卡-贷记卡',
            '622679'     => '中信银行.信用卡中心(63020000)-中信银联标准贷记卡-贷记卡',
            '622680'     => '中信银行.信用卡中心(63020000)-中信银联标准贷记卡-贷记卡',
            '622688'     => '中信银行.信用卡中心(63020000)-中信银联标准贷记卡-贷记卡',
            '622689'     => '中信银行.信用卡中心(63020000)-中信银联标准贷记卡-贷记卡',
            '628206'     => '中信银行.信用卡中心(63020000)-中信银联公务卡-贷记卡',
            '556617'     => '中信银行.信用卡中心(63020000)-中信贷记卡-贷记卡',
            '628209'     => '中信银行.信用卡中心(63020000)-中信银联公务卡-贷记卡',
            '518212'     => '中信银行.信用卡中心(63020000)-中信贷记卡-贷记卡',
            '628208'     => '中信银行.信用卡中心(63020000)-中信银联公务卡-贷记卡',
            '356390'     => '中信银行.信用卡中心(63020000)-中信JCB美元卡-贷记卡',
            '356391'     => '中信银行.信用卡中心(63020000)-中信JCB美元卡-贷记卡',
            '356392'     => '中信银行.信用卡中心(63020000)-中信JCB美元卡-贷记卡',
            '622916'     => '中信银行.信用卡中心(63020000)-中信银联IC卡普卡-贷记卡',
            '622918'     => '中信银行.信用卡中心(63020000)-中信银联IC卡金卡-贷记卡',
            '622919'     => '中信银行.信用卡中心(63020000)-中信银联IC卡白金卡-贷记卡',
            '628370'     => '中信银行.信用卡中心(63020000)-公务IC普卡-贷记卡',
            '628371'     => '中信银行.信用卡中心(63020000)-公务IC金卡-贷记卡',
            '628372'     => '中信银行.信用卡中心(63020000)-公务IC白金卡-贷记卡',
            '303'        => '光大银行-阳光卡-借记卡',
            ...
            '622687'     => '光大银行.(63030000)-存贷合一钻石卡-贷记卡',
            '625978'     => '光大银行.(63030000)-存贷合一IC卡-贷记卡',
            '625980'     => '光大银行.(63030000)-存贷合一IC卡-贷记卡',
            '625981'     => '光大银行.(63030000)-存贷合一IC卡-贷记卡',
            '625979'     => '光大银行.(63030000)-存贷合一IC卡-贷记卡',
            '356839'     => '光大银行.(63030000)-阳光商旅信用卡-贷记卡',
            '356840'     => '光大银行.(63030000)-阳光商旅信用卡-贷记卡',
            '406252'     => '光大银行.(63030000)-阳光信用卡(银联-贷记卡',
            '406254'     => '光大银行.(63030000)-阳光信用卡(银联-贷记卡',
            '425862'     => '光大银行.(63030000)-阳光商旅信用卡-贷记卡',
            '481699'     => '光大银行.(63030000)-阳光白金信用卡-贷记卡',
            '524090'     => '光大银行.(63030000)-安邦俱乐部信用卡-贷记卡',
            '543159'     => '光大银行.(63030000)-足球锦标赛纪念卡-贷记卡',
            '622161'     => '光大银行.(63030000)-光大银行联名公务卡-贷记卡',
            '622570'     => '光大银行.(63030000)-积分卡-贷记卡',
            '622650'     => '光大银行.(63030000)-炎黄卡普卡-贷记卡',
            '622655'     => '光大银行.(63030000)-炎黄卡白金卡-贷记卡',
            '622658'     => '光大银行.(63030000)-炎黄卡金卡-贷记卡',
            '625975'     => '光大银行.(63030000)-贷记IC卡-贷记卡',
            '625977'     => '光大银行.(63030000)-贷记IC卡-贷记卡',
            '628201'     => '光大银行.(63030000)-银联公务卡-贷记卡',
            '628202'     => '光大银行.(63030000)-银联公务卡-贷记卡',
            '625976'     => '光大银行.(63030000)-贷记IC卡-贷记卡',
            '625339'     => '光大银行.(63030000)-银联贷记IC旅游卡-贷记卡',
            '622801'     => '光大银行.(63030000)-贷记IC卡-贷记卡',
            ...
            '9111'       => '广发银行.股份有限公司-广发理财通(银联卡)-借记卡',
            '406365'     => '广发银行.股份有限公司-广发VISA信用卡-贷记卡',
            '406366'     => '广发银行.股份有限公司-广发VISA信用卡-贷记卡',
            '428911'     => '广发银行.股份有限公司-广发信用卡-贷记卡',
            '436768'     => '广发银行.股份有限公司-广发信用卡-贷记卡',
            '436769'     => '广发银行.股份有限公司-广发信用卡-贷记卡',
            '487013'     => '广发银行.股份有限公司-广发VISA信用卡-贷记卡',
            '491032'     => '广发银行.股份有限公司-广发信用卡-贷记卡',
            '491034'     => '广发银行.股份有限公司-广发信用卡-贷记卡',
            '491035'     => '广发银行.股份有限公司-广发信用卡-贷记卡',
            '491036'     => '广发银行.股份有限公司-广发信用卡-贷记卡',
            '491037'     => '广发银行.股份有限公司-广发信用卡-贷记卡',
            '491038'     => '广发银行.股份有限公司-广发信用卡-贷记卡',
            '518364'     => '广发银行.股份有限公司-广发信用卡-贷记卡',
            '520152'     => '广发银行.股份有限公司-广发万事达信用卡-贷记卡',
            '520382'     => '广发银行.股份有限公司-广发万事达信用卡-贷记卡',
            '548844'     => '广发银行.股份有限公司-广发信用卡-贷记卡',
            '552794'     => '广发银行.股份有限公司-广发万事达信用卡-贷记卡',
            '622555'     => '广发银行.股份有限公司-广发银联标准金卡-贷记卡',
            '622556'     => '广发银行.股份有限公司-广发银联标准普卡-贷记卡',
            '622557'     => '广发银行.股份有限公司-广发银联标准真情金卡-贷记卡',
            '622558'     => '广发银行.股份有限公司-广发银联标准白金卡-贷记卡',
            '622559'     => '广发银行.股份有限公司-广发银联标准真情普卡-贷记卡',
            '622560'     => '广发银行.股份有限公司-广发真情白金卡-贷记卡',
            '622568'     => '广发银行.股份有限公司-广发理财通卡-借记卡',
            '528931'     => '广发银行.股份有限公司-广发万事达信用卡-贷记卡',
            '558894'     => '广发银行.股份有限公司-广发万事达信用卡-贷记卡',
            '625072'     => '广发银行.股份有限公司-银联标准金卡-贷记卡',
            '625071'     => '广发银行.股份有限公司-银联标准普卡-贷记卡',
            '628260'     => '广发银行.股份有限公司-银联公务金卡-贷记卡',
            '628259'     => '广发银行.股份有限公司-银联公务普卡-贷记卡',
            '621462'     => '广发银行.股份有限公司-理财通卡-借记卡',
            '625805'     => '广发银行.股份有限公司-银联真情普卡-贷记卡',
            '625806'     => '广发银行.股份有限公司-银联真情金卡-贷记卡',
            '625807'     => '广发银行.股份有限公司-银联真情白金卡-贷记卡',
            '625808'     => '广发银行.股份有限公司-银联标准普卡-贷记卡',
            '625809'     => '广发银行.股份有限公司-银联标准金卡-贷记卡',
            '625810'     => '广发银行.股份有限公司-银联标准白金卡-贷记卡',
            '685800'     => '广发银行.股份有限公司-广发万事达信用卡-贷记卡',
            '620037'     => '广发银行.股份有限公司-广发青年银行预付卡-预付费卡',
            '623506'     => '广发银行.股份有限公司-广发财富管理多币IC卡-借记卡',
            '6858000'    => '广发银行.股份有限公司-广发理财通-贷记卡',
            '6858001'    => '广发银行.股份有限公司-广发理财通-借记卡',
            '6858009'    => '广发银行.股份有限公司-广发理财通-借记卡',
            ...
            '627069'     => '平安银行.股份有限公司-一账通借贷合一钻石卡-借记卡',
            '627068'     => '平安银行.股份有限公司-一账通借贷合一白金卡-借记卡',
            '627066'     => '平安银行.股份有限公司-一账通借贷合一卡普卡-借记卡',
            '627067'     => '平安银行.股份有限公司-一账通借贷合一卡金卡-借记卡',
            '531659'     => '平安银行.股份有限公司-白金信用卡-贷记卡',
            '622157'     => '平安银行.股份有限公司-白金信用卡-贷记卡',
            '435744'     => '平安银行.股份有限公司-沃尔玛百分卡-贷记卡',
            '435745'     => '平安银行.股份有限公司-沃尔玛百分卡-贷记卡',
            '483536'     => '平安银行.股份有限公司-VISA白金卡-贷记卡',
            '622525'     => '平安银行.股份有限公司-人民币信用卡金卡-贷记卡',
            '622526'     => '平安银行.股份有限公司-人民币信用卡普卡-贷记卡',
            '998801'     => '平安银行.股份有限公司-发展信用卡(银联卡)-贷记卡',
            '998802'     => '平安银行.股份有限公司-发展信用卡(银联卡)-贷记卡',
            '528020'     => '平安银行.股份有限公司-平安银行信用卡-贷记卡',
            '622155'     => '平安银行.股份有限公司-平安银行信用卡-贷记卡',
            '622156'     => '平安银行.股份有限公司-平安银行信用卡-贷记卡',
            '526855'     => '平安银行.股份有限公司-平安银行信用卡-贷记卡',
            '356869'     => '平安银行.股份有限公司-信用卡-贷记卡',
            '356868'     => '平安银行.股份有限公司-信用卡-贷记卡',
            '625360'     => '平安银行.股份有限公司-平安中国旅游信用卡-贷记卡',
            '625361'     => '平安银行.股份有限公司-平安中国旅游白金信用卡-贷记卡',
            '628296'     => '平安银行.股份有限公司-公务卡-贷记卡',
            '625825'     => '平安银行.股份有限公司-白金IC卡-贷记卡',
            '625823'     => '平安银行.股份有限公司-贷记IC卡-贷记卡',
            ...
            '370285'     => '招商银行.信用卡中心-美国运通绿卡-贷记卡',
            '370286'     => '招商银行.信用卡中心-美国运通金卡-贷记卡',
            '370287'     => '招商银行.信用卡中心-美国运通商务绿卡-贷记卡',
            '370289'     => '招商银行.信用卡中心-美国运通商务金卡-贷记卡',
            '439225'     => '招商银行.信用卡中心-VISA信用卡-贷记卡',
            '518710'     => '招商银行.信用卡中心-MASTER信用卡-贷记卡',
            '518718'     => '招商银行.信用卡中心-MASTER信用金卡-贷记卡',
            '628362'     => '招商银行.信用卡中心-银联标准公务卡(金卡)-贷记卡',
            '439226'     => '招商银行.信用卡中心-VISA信用卡-贷记卡',
            '628262'     => '招商银行.信用卡中心-银联标准财政公务卡-贷记卡',
            '625802'     => '招商银行.信用卡中心-芯片IC信用卡-贷记卡',
            '625803'     => '招商银行.信用卡中心-芯片IC信用卡-贷记卡',
            '621299'     => '招商银行.香港分行-香港一卡通-借记卡',
            '90592'      => '兴业银行-兴业卡-借记卡',
            ...
            '87050'      => '浦发银行-东方卡-借记卡',
            '84342'      => '浦发银行-东方卡-借记卡',
            '356851'     => '浦发银行-浦发JCB金卡-贷记卡',
            '356852'     => '浦发银行-浦发JCB白金卡-贷记卡',
            '404738'     => '浦发银行-信用卡VISA普通-贷记卡',
            '404739'     => '浦发银行-信用卡VISA金卡-贷记卡',
            '456418'     => '浦发银行-浦发银行VISA年青卡-贷记卡',
            '498451'     => '浦发银行-VISA白金信用卡-贷记卡',
            '515672'     => '浦发银行-浦发万事达白金卡-贷记卡',
            '356850'     => '浦发银行-浦发JCB普卡-贷记卡',
            '517650'     => '浦发银行-浦发万事达金卡-贷记卡',
            '525998'     => '浦发银行-浦发万事达普卡-贷记卡',
            '622177'     => '浦发银行-浦发单币卡-贷记卡',
            '622277'     => '浦发银行-浦发银联单币麦兜普卡-贷记卡',
            '622516'     => '浦发银行-东方轻松理财卡-借记卡',
            '622518'     => '浦发银行-东方轻松理财卡-借记卡',
            '622520'     => '浦发银行-东方轻松理财智业金卡-准贷记卡',
            '622521'     => '浦发银行-东方卡(银联卡)-借记卡',
            '622522'     => '浦发银行-东方卡(银联卡)-借记卡',
            '622523'     => '浦发银行-东方卡(银联卡)-借记卡',
            '628222'     => '浦发银行-公务卡金卡-贷记卡',
            '628221'     => '浦发银行-公务卡普卡-贷记卡',
            '984301'     => '浦发银行-东方卡-借记卡',
            '984303'     => '浦发银行-东方卡-借记卡',
            '622176'     => '浦发银行-浦发单币卡-贷记卡',
            '622276'     => '浦发银行-浦发联名信用卡-贷记卡',
            '622228'     => '浦发银行-浦发银联白金卡-贷记卡',
            '621352'     => '浦发银行-轻松理财普卡-借记卡',
            '621351'     => '浦发银行-移动联名卡-借记卡',
            '621390'     => '浦发银行-轻松理财消贷易卡-借记卡',
            '621792'     => '浦发银行-轻松理财普卡（复合卡）-借记卡',
            '625957'     => '浦发银行-贷记卡-贷记卡',
            '625958'     => '浦发银行-贷记卡-贷记卡',
            '621791'     => '浦发银行-东方借记卡（复合卡）-借记卡',
            '620530'     => '浦发银行-电子现金卡（IC卡）-预付费卡',
            '625993'     => '浦发银行-移动浦发联名卡-贷记卡',
            '622519'     => '浦发银行-东方-标准准贷记卡-准贷记卡',
            '621793'     => '浦发银行-轻松理财金卡（复合卡）-借记卡',
            '621795'     => '浦发银行-轻松理财白金卡（复合卡）-借记卡',
            '621796'     => '浦发银行-轻松理财钻石卡（复合卡）-借记卡',
            '625971'     => '浦发银行.信用卡中心(63100000)-移动浦发借贷合一联名卡-贷记卡',
            '625970'     => '浦发银行.信用卡中心(63100000)-贷记卡-贷记卡',
            '377187'     => '浦发银行.信用卡中心(63100000)-浦发私人银行信用卡-贷记卡',
            '625831'     => '浦发银行.信用卡中心(63100000)-中国移动浦发银行联名手机卡-贷记卡',
            '622500'     => '浦发银行-东方卡-贷记卡',
            ...
            '940008'     => '齐鲁银行.股份有限公司-齐鲁卡(银联卡)-借记卡',
            '622379'     => '齐鲁银行.股份有限公司-齐鲁卡(银联卡)-借记卡',
            ...
            '621019'     => '浙商银行-商卡-借记卡',
            '6223091100' => '浙商银行.天津分行-商卡-借记卡',
            '6223092900' => '浙商银行.上海分行-商卡-借记卡',
            '6223093310' => '浙商银行.营业部-商卡(银联卡)-借记卡',
            '6223093320' => '浙商银行.宁波分行-商卡(银联卡)-借记卡',
            '6223093330' => '浙商银行.温州分行-商卡(银联卡)-借记卡',
            '6223093370' => '浙商银行.绍兴分行-商卡-借记卡',
            '6223093380' => '浙商银行.义乌分行-商卡(银联卡)-借记卡',
            '6223096510' => '浙商银行.成都分行-商卡(银联卡)-借记卡',
            '6223097910' => '浙商银行.西安分行-商卡-借记卡',
            ...
            '625076'     => '花旗银行-花旗礼享卡-贷记卡',
            '625077'     => '花旗银行-花旗礼享卡-贷记卡',
            '625074'     => '花旗银行-花旗礼享卡-贷记卡',
            '625075'     => '花旗银行-花旗礼享卡-贷记卡',
            '622371'     => '花旗银行.有限公司(25030344)-花旗人民币信用卡-贷记卡',
            '625091'     => '花旗银行.有限公司(25030344)-双币卡-贷记卡',
            '622933'     => '东亚银行.中国有限公司-紫荆卡-借记卡',
            '622938'     => '东亚银行.中国有限公司-显卓理财卡-借记卡',
            '623031'     => '东亚银行.中国有限公司-借记卡-借记卡',
            ...
            '622372'     => '东亚银行.有限公司(25020344)-cup credit card-贷记卡',
            '622365'     => '东亚银行.有限公司(25020344)-电子网络人民币卡-借记卡',
            '622471'     => '东亚银行.有限公司(25020344)-人民币信用卡(银联卡)-贷记卡',
            '622943'     => '东亚银行.有限公司(25020344)-银联借记卡-借记卡',
            '622472'     => '东亚银行.有限公司(25020344)-人民币信用卡金卡-贷记卡',
            '623318'     => '东亚银行.有限公司(25020344)-银联双币借记卡-借记卡',
            '621411'     => '东亚银行.澳门分行(25020446)-银联借记卡-借记卡',
            '622946'     => '汇丰银行.(中国)有限公司-汇丰中国卓越理财卡-借记卡',
            '622360'     => '汇丰银行.香港上海汇丰银行有限公司(25120344)-人民币卡(银联卡)-贷记卡',
            '622361'     => '汇丰银行.香港上海汇丰银行有限公司(25120344)-人民币金卡(银联卡)-贷记卡',
            '625034'     => '汇丰银行.香港上海汇丰银行有限公司(25120344)-银联卡-贷记卡',
            '625096'     => '汇丰银行.香港上海汇丰银行有限公司(25120344)-汇丰银联双币卡-贷记卡',
            '625098'     => '汇丰银行.香港上海汇丰银行有限公司(25120344)-汇丰银联双币钻石卡-贷记卡',
            '622406'     => '汇丰银行.香港上海汇丰银行有限公司(25130344)-TMCard-借记卡',
            '622407'     => '汇丰银行.香港上海汇丰银行有限公司(25130344)-TMCard-借记卡',
            '621442'     => '汇丰银行.香港上海汇丰银行有限公司(25130344)-借记卡-借记卡',
            '621443'     => '汇丰银行.香港上海汇丰银行有限公司(25130344)-借记卡-借记卡',
            '622942'     => '渣打银行.中国有限公司-渣打银行智通借记卡-借记卡',
            '622994'     => '渣打银行.中国有限公司-渣打银行白金借记卡-借记卡',
            '622948'     => '渣打银行.香港有限公司(25280344)-港币借记卡-借记卡',
            '621740'     => '渣打银行.（香港）(25280344)-银联标准卡-借记卡',
            '622482'     => '渣打银行.香港有限公司(25280344)-双币信用卡-贷记卡',
            '622483'     => '渣打银行.香港有限公司(25280344)-双币信用卡-贷记卡',
            '622484'     => '渣打银行.香港有限公司(25280344)-双币信用卡-贷记卡',
            '621016'     => '星展银行-星展银行借记卡-借记卡',
            '621015'     => '星展银行-星展银行借记卡-借记卡',
            '622487'     => '星展银行.香港有限公司(25080344)-银联人民币银行卡-借记卡',
            '622490'     => '星展银行.香港有限公司(25080344)-银联人民币银行卡-借记卡',
            '622491'     => '星展银行.香港有限公司(25080344)-银联银行卡-借记卡',
            '622492'     => '星展银行.香港有限公司(25080344)-银联银行卡-借记卡',
            '621744'     => '星展银行.香港有限公司(25080344)-借记卡-借记卡',
            '621745'     => '星展银行.香港有限公司(25080344)-借记卡-借记卡',
            '621746'     => '星展银行.香港有限公司(25080344)-借记卡-借记卡',
            '621747'     => '星展银行.香港有限公司(25080344)-借记卡-借记卡',
            '622950'     => '恒生银行-恒生通财卡-借记卡',
            '622951'     => '恒生银行-恒生优越通财卡-借记卡',
            '625026'     => '恒生银行.有限公司(25140344)-港币贷记白金卡-贷记卡',
            '625024'     => '恒生银行.有限公司(25140344)-港币贷记普卡-贷记卡',
            '622376'     => '恒生银行.有限公司(25140344)-恒生人民币信用卡-贷记卡',
            '622378'     => '恒生银行.有限公司(25140344)-恒生人民币白金卡-贷记卡',
            '622377'     => '恒生银行.有限公司(25140344)-恒生人民币金卡-贷记卡',
            '625092'     => '恒生银行.有限公司(25140344)-银联人民币钻石商务卡-贷记卡',
            ...
            '622611'     => '上海农商银行.贷记卡(65012900)-鑫卡-贷记卡',
            '622722'     => '上海农商银行.贷记卡(65012900)-商务卡-贷记卡',
            '628211'     => '上海农商银行.贷记卡(65012900)-银联标准公务卡-贷记卡',
            '625500'     => '上海农商银行.贷记卡(65012900)-福农卡-准贷记卡',
            '625989'     => '上海农商银行.贷记卡(65012900)-鑫通卡-贷记卡',
            ...
            '622393'     => '厦门银行.股份有限公司-银鹭借记卡(银联卡)-借记卡',
            '6886592'    => '厦门银行.股份有限公司-银鹭卡-借记卡',
            '940023'     => '厦门银行.股份有限公司-银联卡(银联卡)-借记卡',
            '623019'     => '厦门银行.股份有限公司-凤凰花卡-借记卡',
            '621600'     => '厦门银行.股份有限公司-凤凰花卡-借记卡',
            '622388'     => '福建海峡银行.股份有限公司-榕城卡(银联卡)-借记卡',
            '621267'     => '福建海峡银行.股份有限公司-福州市民卡-借记卡',
            '620043'     => '福建海峡银行.股份有限公司-福州市民卡-预付费卡',
            '623063'     => '福建海峡银行.股份有限公司-海福卡（IC卡）-借记卡',
            ...
            '621977'     => '温州银行-金鹿卡-借记卡',
            '603445'     => '广州银行.股份有限公司-羊城借记卡-借记卡',
            '622467'     => '广州银行.股份有限公司-羊城借记卡(银联卡)-借记卡',
            '940016'     => '广州银行.股份有限公司-羊城借记卡(银联卡)-借记卡',
            '621463'     => '广州银行.股份有限公司-金融IC借记卡-借记卡',
            '990027'     => '汉口银行-九通卡(银联卡)-借记卡',
            '622325'     => '汉口银行-九通卡-借记卡',
            '623029'     => '汉口银行-借记卡-借记卡',
            '623105'     => '汉口银行-借记卡-借记卡',
            '622475'     => '龙江银行.股份有限公司-金鹤卡-借记卡',
            '621244'     => '盛京银行-玫瑰卡-借记卡',
            ...
            '623118'     => '洛阳银行--借记卡',
            '622399'     => '辽阳银行.股份有限公司-新兴卡(银联卡)-借记卡',
            '940043'     => '辽阳银行.股份有限公司-新兴卡(银联卡)-借记卡',
            '628309'     => '辽阳银行.股份有限公司-公务卡-贷记卡',
            '623151'     => '辽阳银行.股份有限公司-新兴卡-借记卡',
            ...
            '622498'     => '河北银行.股份有限公司-如意借记卡(银联卡)-借记卡',
            '622499'     => '河北银行.股份有限公司-如意借记卡(银联卡)-借记卡',
            '940046'     => '河北银行.股份有限公司-如意卡(银联卡)-借记卡',
            '623000'     => '河北银行.股份有限公司-借记IC卡-借记卡',
            ...
            '940051'     => '金华银行.股份有限公司-双龙卡(银联卡)-借记卡',
            '628204'     => '金华银行.股份有限公司-公务卡-贷记卡',
            '622449'     => '金华银行.股份有限公司-双龙借记卡-借记卡',
            '623067'     => '金华银行.股份有限公司-双龙社保卡-借记卡',
            '622450'     => '金华银行.股份有限公司-双龙贷记卡(银联卡)-贷记卡',
            ...
            '622486'     => '绍兴银行.股份有限公司-兰花卡(银联卡)-借记卡',
            '603602'     => '绍兴银行.股份有限公司-兰花卡-借记卡',
            ...
            '622442'     => '抚顺银行.股份有限公司-绿叶卡(银联卡)-借记卡',
            '940053'     => '抚顺银行.股份有限公司-绿叶卡(银联卡)-借记卡',
            ...
            '621452'     => '天津市商业银行----借记卡',
            '628205'     => '天津银行-商务卡-贷记卡',
            '622421'     => '郑州银行.股份有限公司-世纪一卡通(银联卡)-借记卡',
            '940056'     => '郑州银行.股份有限公司-世纪一卡通-借记卡',
            '96828'      => '郑州银行.股份有限公司-世纪一卡通-借记卡',
            ...
            '622363'     => '珠海华润银行.股份有限公司-万事顺卡-借记卡',
            '940048'     => '珠海华润银行.股份有限公司-万事顺卡(银联卡)-借记卡',
            '621455'     => '珠海华润银行.股份有限公司-珠海华润银行IC借记卡-借记卡',
            '940057'     => '齐商银行-金达卡(银联卡)-借记卡',
            '622311'     => '齐商银行-金达借记卡(银联卡)-借记卡',
            '623119'     => '齐商银行-金达IC卡-借记卡',
            '622990'     => '锦州银行.股份有限公司-7777卡-借记卡',
            '940003'     => '锦州银行.股份有限公司-万通卡(银联卡)-借记卡',
            '622877'     => '徽商银行-黄山卡-借记卡',
            '622879'     => '徽商银行-黄山卡-借记卡',
            '621775'     => '徽商银行-借记卡-借记卡',
            '623203'     => '徽商银行-徽商银行中国旅游卡（安徽）-借记卡',
            '603601'     => '徽商银行.合肥分行-黄山卡-借记卡',
            '622137'     => '徽商银行.芜湖分行-黄山卡(银联卡)-借记卡',
            '622327'     => '徽商银行.马鞍山分行-黄山卡(银联卡)-借记卡',
            '622340'     => '徽商银行.淮北分行-黄山卡(银联卡)-借记卡',
            '622366'     => '徽商银行.安庆分行-黄山卡(银联卡)-借记卡',
            '9896'       => '重庆银行-长江卡-借记卡',
            ...
            '622133'     => '贵阳银行.股份有限公司-甲秀银联借记卡-借记卡',
            '888'        => '贵阳银行.股份有限公司-甲秀卡-借记卡',
            '621735'     => '贵阳银行.股份有限公司-一卡通-借记卡',
            '622170'     => '贵阳银行.股份有限公司--借记卡',
            '622136'     => '西安银行.股份有限公司-福瑞卡-借记卡',
            '622981'     => '西安银行.股份有限公司-金丝路卡-借记卡',
            '60326500'   => '无锡市商业银行-太湖卡-借记卡',
            '60326513'   => '无锡市商业银行-太湖卡-借记卡',
            '622485'     => '无锡市商业银行-太湖金保卡(银联卡)-借记卡',
            '622415'     => '丹东银行.股份有限公司-银杏卡(银联卡)-借记卡',
            '940060'     => '丹东银行.股份有限公司-银杏卡(银联卡)-借记卡',
            '623098'     => '丹东银行-借记IC卡-借记卡',
            '628329'     => '丹东银行-丹东银行公务卡-贷记卡',
            '622139'     => '兰州银行.股份有限公司-敦煌国际卡(银联卡)-借记卡',
            '940040'     => '兰州银行.股份有限公司-敦煌卡-借记卡',
            '621242'     => '兰州银行.股份有限公司-敦煌卡-借记卡',
            '621538'     => '兰州银行-敦煌卡-借记卡',
            '621496'     => '兰州银行.股份有限公司-敦煌金融IC卡-借记卡',
            '623129'     => '兰州银行.股份有限公司-金融社保卡-借记卡',
            ...
            '622162'     => '九江银行.股份有限公司-庐山卡-借记卡',
            '623077'     => '日照银行-黄海卡、财富卡借记卡-借记卡',
            '622413'     => '鞍山银行-千山卡(银联卡)-借记卡',
            '940002'     => '鞍山银行-千山卡(银联卡)-借记卡',
            '623188'     => '鞍山银行-千山卡-借记卡',
            '621237'     => '秦皇岛银行.股份有限公司-秦卡-借记卡',
            '62249802'   => '秦皇岛银行.股份有限公司-秦卡-借记卡',
            '94004602'   => '秦皇岛银行.股份有限公司-秦卡-借记卡',
            '623003'     => '秦皇岛银行.股份有限公司-秦卡-IC卡-借记卡',
            ...
            '694301'     => '长沙银行.股份有限公司-芙蓉卡-借记卡',
            '940071'     => '长沙银行.股份有限公司-芙蓉卡(银联卡)-借记卡',
            '622368'     => '长沙银行.股份有限公司-芙蓉卡(银联卡)-借记卡',
            '621446'     => '长沙银行.股份有限公司-芙蓉金融IC卡-借记卡',
            '625901'     => '长沙银行.股份有限公司-市民卡-贷记卡',
            '622898'     => '长沙银行.股份有限公司-芙蓉贷记卡-贷记卡',
            '622900'     => '长沙银行.股份有限公司-芙蓉贷记卡-贷记卡',
            '628281'     => '长沙银行.股份有限公司-公务卡钻石卡-贷记卡',
            '628282'     => '长沙银行.股份有限公司-公务卡金卡-贷记卡',
            '628283'     => '长沙银行.股份有限公司-公务卡普卡-贷记卡',
            '620519'     => '长沙银行.股份有限公司-市民卡-预付费卡',
            '621739'     => '长沙银行.股份有限公司-借记IC卡-借记卡',
            ...
            '623518'     => '龙江银行----借记卡',
            '622860'     => '龙江银行.股份有限公司-玉兔卡(银联卡)-借记卡',
            ...
            '909810'     => '广州农村商业银行.股份有限公司-麒麟卡-借记卡',
            '940035'     => '广州农村商业银行.股份有限公司-麒麟卡(银联卡)-借记卡',
            '621522'     => '广州农村商业银行-福农太阳卡-借记卡',
            '622439'     => '广州农村商业银行.股份有限公司-麒麟储蓄卡-借记卡',
            ...
            '622481'     => '江阴农村商业银行-合作贷记卡(银联卡)-贷记卡',
            '622341'     => '江阴农村商业银行-合作借记卡-借记卡',
            '940058'     => '江阴农村商业银行-合作卡(银联卡)-借记卡',
            '623115'     => '江阴农村商业银行-暨阳卡-借记卡',
            '622867'     => '重庆农村商业银行.股份有限公司-信合平安卡-借记卡',
            '622885'     => '重庆农村商业银行.股份有限公司-信合希望卡-借记卡',
            '940020'     => '重庆农村商业银行.股份有限公司-信合一卡通(银联卡)-借记卡',
            ...
            '622138'     => '北京农商行-信通卡-借记卡',
            '621066'     => '北京农商行-惠通卡-借记卡',
            '621560'     => '北京农商行-凤凰福农卡-借记卡',
            '621068'     => '北京农商行-惠通卡-借记卡',
            '620088'     => '北京农商行-中国旅行卡-借记卡',
            '621067'     => '北京农商行-凤凰卡-借记卡',
            ...
            '622339'     => '宁波鄞州农村合作银行-蜜蜂借记卡(银联卡)-借记卡',
            ...
            '622345'     => '成都农村商业银行.股份有限公司-天府借记卡(银联卡)-借记卡',
            ...
            '622855'     => '苏州银行.股份有限公司-新苏卡(银联卡)-借记卡',
            '621461'     => '苏州银行.股份有限公司-新苏卡-借记卡',
            '623521'     => '苏州银行.股份有限公司-金桂卡-借记卡',
            ...
            '622293'     => '大新银行.有限公司(25040344)-信用卡(普通卡)-贷记卡',
            '622295'     => '大新银行.有限公司(25040344)-商务信用卡-贷记卡',
            '622296'     => '大新银行.有限公司(25040344)-商务信用卡-贷记卡',
            '622297'     => '大新银行.有限公司(25040344)-预付卡(普通卡)-借记卡',
            '622373'     => '大新银行.有限公司(25040344)-人民币信用卡-贷记卡',
            '622375'     => '大新银行.有限公司(25040344)-人民币借记卡(银联卡)-借记卡',
            '622451'     => '大新银行.有限公司(25040344)-大新人民币信用卡金卡-贷记卡',
            '622294'     => '大新银行.有限公司(25040344)-大新港币信用卡(金卡)-贷记卡',
            '625940'     => '大新银行.有限公司(25040344)-贷记卡-贷记卡',
            '622489'     => '大新银行.有限公司(25040344)-借记卡(银联卡)-借记卡',
            ...
            '622387'     => '永隆银行.有限公司(25100344)-永隆人民币信用卡-贷记卡',
            '622423'     => '永隆银行.有限公司(25100344)-永隆人民币信用卡-贷记卡',
            '622971'     => '永隆银行.有限公司(25100344)-永隆港币卡-借记卡',
            '622970'     => '永隆银行.有限公司(25100344)-永隆人民币卡-借记卡',
            '625062'     => '永隆银行.有限公司(25100344)-永隆双币卡-贷记卡',
            '625063'     => '永隆银行.有限公司(25100344)-永隆双币卡-贷记卡',
            '622453'     => '中信嘉华银行.有限公司(25160344)-人民币信用卡金卡-贷记卡',
            '622456'     => '中信嘉华银行.有限公司(25160344)-信用卡普通卡-贷记卡',
            '622459'     => '中信嘉华银行.有限公司(25160344)-人民币借记卡(银联卡)-借记卡',
            '624303'     => '中信嘉华银行.有限公司(25160344)-信银国际国航知音双币信用卡-贷记卡',
            '623328'     => '中信嘉华银行.有限公司(25160344)-CNCBI HKD CUP Debit Card-借记卡',
            '622272'     => '创兴银行.有限公司(25170344)-银联贺礼卡(创兴银行)-借记卡',
            '622463'     => '创兴银行.有限公司(25170344)-港币借记卡-借记卡',
            '621087'     => '创兴银行.有限公司(25170344)-人民币提款卡-借记卡',
            '625008'     => '创兴银行.有限公司(25170344)-银联双币信用卡-贷记卡',
            '625009'     => '创兴银行.有限公司(25170344)-银联双币信用卡-贷记卡',
            ...
            '625198'     => '大丰银行.有限公司(25250446)-银联双币白金卡-贷记卡',
            '625196'     => '大丰银行.有限公司(25250446)-银联双币金卡-贷记卡',
            '622547'     => '大丰银行.有限公司(25250446)-港币借记卡-借记卡',
            '622548'     => '大丰银行.有限公司(25250446)-澳门币借记卡-借记卡',
            '622546'     => '大丰银行.有限公司(25250446)-人民币借记卡-借记卡',
            '625147'     => '大丰银行.(25250446)-中银银联双币商务卡-贷记卡',
            '620072'     => '大丰银行.有限公司(25250446)-大丰预付卡-预付费卡',
            '620204'     => '大丰银行.有限公司(25250446)-大丰银行预付卡-预付费卡',
            '620205'     => '大丰银行.有限公司(25250446)-大丰银行预付卡-预付费卡',
            ...
            '628379'     => '齐鲁银行.股份有限公司(64094510)-泉城公务卡-贷记卡',
            '625050'     => '广州银行.股份有限公司(64135810)-广州银行信用卡-贷记卡',
            '625836'     => '广州银行.股份有限公司(64135810)-贷记IC卡-贷记卡',
            '628367'     => '广州银行.股份有限公司(64135810)-银联标准公务卡-贷记卡',
            '628333'     => '龙江银行.股份有限公司(64162640)-公务卡-贷记卡',
            '622921'     => '河北银行.股份有限公司(64221210)-如意贷记卡-贷记卡',
            '628321'     => '河北银行.股份有限公司(64221210)-如意贷记卡-贷记卡',
            '625598'     => '河北银行.股份有限公司(64221210)-福农卡-贷记卡',
            ...
            '622613'     => '重庆银行.股份有限公司(64416910)-银联标准卡-贷记卡',
            '628220'     => '重庆银行.股份有限公司(64416910)-银联标准公务卡-贷记卡',
            ...
            '621727'     => '广东南粤银行.股份有限公司(64895910)-湛江市民卡-借记卡',
            '623128'     => '广东南粤银行.股份有限公司(64895910)----借记卡',
            '628237'     => '广东南粤银行.(64895919)-公务卡-贷记卡',
            '628219'     => '桂林银行.(64916170)-漓江公务卡-贷记卡',
            '621456'     => '桂林银行.(64916170)-漓江卡-借记卡',
            '621562'     => '桂林银行.(64916170)-福农IC卡-借记卡',
            '622270'     => '龙江银行.股份有限公司(64922690)-玉兔贷记卡-贷记卡',
            '628368'     => '龙江银行.股份有限公司(64922690)-玉兔贷记卡(公务卡)-贷记卡',
            '625588'     => '龙江银行.(64922690)-福农准贷记卡-准贷记卡',
            '625090'     => '龙江银行.股份有限公司(64922690)-联名贷记卡-贷记卡',
            '62536602'   => '龙江银行.股份有限公司(64922690)-中国旅游卡-贷记卡',
            ...
            '622808'     => '成都农村商业银行.股份有限公司(65226510)-天府贷记卡-贷记卡',
            '628308'     => '成都农村商业银行.股份有限公司(65226510)-天府公务卡-贷记卡',
            '623088'     => '成都农村商业银行.股份有限公司(65226510)-天府借记卡-借记卡',
            ...
            '623165'     => '西安银行.股份有限公司-金丝路借记卡-借记卡',
        ];

        $card10 = substr($cardno, 0, 10);
        if (isset($bankList[$card10])) {
            $bank = $bankList[$card10];
            return self::getBankInfo($bank);
        }

        $card9 = substr($cardno, 0, 9);
        if (isset($bankList[$card9])) {
            $bank = $bankList[$card9];
            return self::getBankInfo($bank);
        }

        $card8 = substr($cardno, 0, 8);
        if (isset($bankList[$card8])) {
            $bank = $bankList[$card8];
            return self::getBankInfo($bank);
        }

        $card7 = substr($cardno, 0, 7);
        if (isset($bankList[$card7])) {
            $bank = $bankList[$card7];
            return self::getBankInfo($bank);
        }

        $card6 = substr($cardno, 0, 6);
        if (isset($bankList[$card6])) {
            $bank = $bankList[$card6];
            return self::getBankInfo($bank);
        }

        $card5 = substr($cardno, 0, 5);
        if (isset($bankList[$card5])) {
            $bank = $bankList[$card5];
            return self::getBankInfo($bank);
        }

        $card4 = substr($cardno, 0, 4);
        if (isset($bankList[$card4])) {
            $bank = $bankList[$card4];
            return self::getBankInfo($bank);
        }

        $card3 = substr($cardno, 0, 3);
        if (isset($bankList[$card3])) {
            $bank = $bankList[$card3];
            return self::getBankInfo($bank);
        }
    }
     ...
     * 根据银行信息，分解银行详细信息
     */
    private static function getBankInfo($info)
    {
        if (!$info) {
            return false;
        }
        ...
        $cardname = isset($tmp[1]) ? $tmp[1] : "";
        $cardtype = isset($tmp[2]) ? $tmp[2] : "";
        return ["bankname" => $bankname, "cardname" => $cardname, "cardtype" => $cardtype];
    }

    /**
     * 根据银行信息，获得汇付宝银行编号
     */
    public static function getHeepayBankNo($bankname)
    {
        if (!$bankname) {
            return false;
        }
        ...
        if (!isset($nolist[$bankname])) {
            return false;
        }
        return $nolist[$bankname];
    }

    /**
     * 根据银行信息，获得汇付宝银行编号
     */
    public static function getBankNoByCardNo($cardno)
    {
        if (!$cardno) {
            return false;
        }
        $info = self::getBankType($cardno);
        if (!$info || !is_array($info) || !isset($info['bankname'])) {
            return false;
        }
        $bankno = self::getHeepayBankNo($info['bankname']);
        if (!$bankno) {
            return false;
        }
        return $bankno;
     ...
     * 根据银行信息，获得银行名称
     */
    public static function getBankNoByCardName($cardno)
    {
        if (!$cardno) {
            return false;
        }
