...
(function(w, $) {
    ...
    var minipay = {
        ...
        url: "http://www.vronline.com/minipay",
        ...
        iframeTemp: function() {
            var _this = this;
            return '<div id="' + _this.id + '" style="z-index: 10; width: 576px;height: 400px; left: 50%; top:50%; transform: translate(-50%,-50%); position: absolute;display:none;background:#1c202a;"><div style="position: absolute;display: block;width: 18px;height: 20px;right: 14px;top: 10px;background: url(http://pic.vronline.com/common/images/icon.png) no-repeat -96px -200px; cursor:pointer;" class="close_btn"></div><iframe src="" name="minipay" id="minipay" frameborder="0" width="100%" height="100%"></iframe></div>';
        },
