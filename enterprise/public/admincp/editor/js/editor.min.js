...
_e(function (E, $) {
    ...
    E.createMenu(function (check) {
        ...
        var youku = /<embed(.*?)player.youku.com(.*?)sid\/(.*?)\//i;
        ...
        $btnSubmit.click(function (e) {
            ...
            var youkuArr = link.match(youku);
            if(youkuArr && youkuArr.length==4){
                var youkuId = youkuArr[3];
                link = "<iframe src='http://player.youku.com/embed/"+youkuId+"' frameborder=0 'allowfullscreen'></iframe>"
            }
...
_e(function (E, $) {
    ...
    E.plugin(function () {
        ...
        function cos(tp,file,callback,errback,addParams) {
            var name =  getFileName(tp,file);
            var cos = new Cos(tp);
        ...
        editor.xhrUploadImg = function (opt) {
            ...
            if(params.cos) {
                cos(params.tp,convertBase64UrlToBlob(base64, fileType),function(json){
                     var jsonResult = $.parseJSON(json);
                     var path = jsonResult.data.fileid;
                     loadfn && loadfn.call(editor, img_domain+path);
                },function(){
                    errorfn && errorfn.call(editor);
                });
            } else {
                    // 变量声明
