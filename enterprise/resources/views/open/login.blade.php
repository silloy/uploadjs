...
<body>
    <div class="home_header">
        <div class="home_container pr">
            ...
            <div class="login pa login_in_pre" {!! $style1 !!} >
            ...
            <div class="login login_in pa tac" {!! $style2 !!} >
                <h3 class="f20 tal">你好 !</h3>
                <span class="user_img">
                    <img src="{!! $face !!}">
                </span>
                <p class="user_name f26"><span>{!! $nick !!} </span> <a href="/logout">退出</a></p>
                <p class="btn login_btn">
                    <span class="f14 btn-product">管理中心</span>
                    <span class="f14 btn-my">开发者资料</span>
                </p>
            </div>
        </div>
    </div>
...
$(function(){
    ...
    $(".btn-product").click(function(){
        location.href = "//open.vronline.com/developer/vrgame";
    });

     $(".btn-my").click(function() {
        location.href = "//open.vronline.com/developer/user";
    });
