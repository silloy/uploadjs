        ...
        <div class="in_con">
            ...
            <div class="content product-detail">
                ...
                <div class="product-manage clearfix" data-id="{{ $detail["appid"] }}">
                    <dl class="btn-webgame-info" data-src="base">
                        <dt>
                    ...
                    <dl class="btn-webgame-info" data-src="res">
                        <dt>
                    ...
                    <dl class="btn-webgame-info" data-src="server">
                        <dt>
                            <span class="product-manage-icon icon-server"></span>
                            <span class="product-manage-title">服务器状态</span>
                        </dt>
                        <dd>确定服务器地址，新增服务器、开服时间等</dd>
                    </dl>
                    <dl class="btn-webgame-info"  data-src="copyright">
                        <dt>
