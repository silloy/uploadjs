...
@section('role_intro')
            ...
            <div class="nav clearfix">
                <div class="fl part clearfix">
                    <div class="fl f18 cur">文官</div>
                    <div class="fl f18 warrior">武将</div>
                    <div class="fl f18 master">副将</div>
                </div>
                <!-- <a class="fr clearfix" href="javascript:;"><span class="fl f14">更多</span><span class="fr">+</span></a> -->
            </div>
            <div class="newsCon show">
                <img class="role_bg" src="//pic.vronline.com/webgames/images/1000035/wenguan.png" />
            </div>
            <div class="newsCon">
                <img class="role_bg" src="//pic.vronline.com/webgames/images/1000035/wujiang.png" />
            </div>
            <div class="newsCon">
                <img class="role_bg" src="//pic.vronline.com/webgames/images/1000035/fujiang.png" />
            </div>
@endsection
