...
<div class="ui grid" style="clear:both">
  <div class="ten wide column">
        ...
        <div class="two fields">
            <div class="field">
            <label>分类</label>
            <select id="article_category" class="ui selection dropdown"  multiple="" >
            <option value="">请选择</option>
            {!! $blade->showHtmlClass('vronline_news','','select') !!}
            </select>
            </div>
            <div class="field">
            <label>标签</label>
...
var article_category = $('#article_category').dropdown();
...
$(function () {
    ...
    loi.edit("vronline_news",article_id,function(data){
...
function save(style) {
    ...
    if(typeof(editData.err) == "undefined") {
        ...
        if(formData.article_content!=last_content || style==2) {
            permPost("/json/save/vronline_news",formData,function(res){
                if(res.code!=0) {
                    loiMsg(res.msg);
                } else {
