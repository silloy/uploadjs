...
@section('content')
    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
        ...
        <a class="btn btn-primary pull-right sortAddBtn" href="javascript:void(0);" style="margin-right: 5%;">
            添加推荐位类别 - [&nbsp;<span class="glyphicon glyphicon-plus icon-plus-sign-alt pointer"></span>&nbsp;]
        </a>
        <!--推荐位添加和修改的区块-->
                    ...
                    <div class="span12">
                        ...
                        <div class="widget-body">
                            ...
                            <form class="form-horizontal" action="{{ url('schedule/add') }}" method="post" name="addForm" id="addForm" enctype="multipart/form-data">
                                ...
                                <input type="hidden" name="type" id="type" class="form-control" value="{{ $code }}"/>
                        ...
                        <ul aria-labelledby="drop4" role="menu" class="dropdown-menu" id="menu1">
                            @if(isset($sort[$gk]) && !empty($sort[$gk]))
                                @foreach($sort[$gk] as $sk =>$sv)
                                    <li role="presentation" id="{{$sv['posid']}}" ><a href="/recommendWebGame/{{$sv['code']}}" class="@if($sv['posid'] == $posid) btn-info @endif">{{$sv['desc']}}</a></li>
                                @endforeach
                            @endif
                        </ul>
                    </li>
                                                    ...
                                                    @if(isset($v['tmp']) || !empty($v['tmp']))
                                                        @foreach($v['tmp'] as $tk=>$tv)
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <a href="javascript:void(0);" class="accountEditBtn" data-uniqId="{{ $tv['id'] }}" data-itemId="{{ $tv['itemid'] }}" data-posId="{{ $posid }}"  data-weight="{{ $k}}" data-openTm="{{ date('Y-m-d H:i:s', $tv['start']) }}" data-endTm=""><button class="btn btn-primary"><i class="icon-pencil"></i></button></a>
                                                                </td>
                                                            </tr>
                                                        @endforeach
                                                    @else
